ninja.wallets.bulkwallet = {
	...
	// rowLimit: number of CryptoCashBack Addresses to generate
	// startIndex: add this number to the row index for output purposes
	// returns:
	// index,cryptocashbackAddress,privateKeyWif
