	...
	view: function () {
		...
		if (key == keyConfirm || document.getElementById("brainpassphraseshow").checked) {
			...
			if (key.length >= ninja.wallets.brainwallet.minPassphraseLength) {
				...
				var privWif = ccbcKey.getCryptoCashBackWalletImportFormat();
				document.getElementById("brainccbcaddress").innerHTML = cryptocashbackAddress;
				document.getElementById("brainccbcprivwif").innerHTML = privWif;
				ninja.qrCode.showQrCode({
					"brainqrcodepublic": cryptocashbackAddress,
