"ua": {
  "choosecurrency": "Оберіть валюту",
    ...
    "donate": "Пожертвувати",
    "generatelabelcryptocashbackaddress": "Створюється нова адреса...",
    ...
    "singlelabelcryptocashbackaddress": "Публічна адреса",
    ...
    "securitystep0": "Насамперед <strong>завантажте</strong> цей сайт з <a href=\"https://github.com/CryptoCashBack-Hub/ccbc-paper-wallet\">Github</a>, розархівуйте його і безпосередньо з вашого комп'ютера відкрийте файл index.html. Це достатньо просто сховати деякий шкідливий код у 6000+ рядків javascript, щоб поцупити ваш приватний ключ, але ви ж не хочете довідатися, що ваші кошти вкрадено. Контроль версії кода дозволяє набагато простіше перевіряти діючу програму. Для забезпечення додаткової безпеки, <strong>відключіть доступ до Інтернету</strong> під час створення вашого гаманця.",
    ...
    "brainlabelcryptocashbackaddress": "Публічна адреса:",
    ...
    "detaillabelcryptocashbackaddress": "Публічна адреса",
    "detaillabelcryptocashbackaddresscomp": "Публічна адреса (стиснута)",
    ...
    "footersupport": "Підтримати CryptoCashBack-paperwallet",
    ...
    "defaultTitle": "CryptoCashBack-paperwallet - універсальний генератор паперових гаманців для біткойнів та інших криптовалют",
