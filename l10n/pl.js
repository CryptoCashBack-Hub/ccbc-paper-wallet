"pl": {
  "choosecurrency": "Wybierz walutę",
    ...
    "donate": "Wsparcie",
    "generatelabelcryptocashbackaddress": "Generowanie nowego adresu...",
    ...
    "singlelabelcryptocashbackaddress": "Adres publiczny",
    ...
    "securitystep0": "Po pierwsze - <strong>pobierz</strong> tę stronę z <a href=\"https://github.com/CryptoCashBack-Hub/ccbc-paper-wallet\">Githuba</a> i otwórz plik index.html bezpośrednio ze swojego komputera. Wprowadzenie złośliwego kodu do strony, która zawiera ponad 6000 linijek kodu javascript jest dość proste i może skutkować wyciekiem Twojego klucza prywatnego, a co za tym idzie, utratą wszystkich środków z portfela. Aby zapewnić dodatkowe bezpieczeństwo, należy <strong>odłączyć się od Internetu</strong> podczas generowania portfela dla bezpieczeństwa.",
    ...
    "brainlabelcryptocashbackaddress": "Adres publiczny:",
    ...
    "detaillabelcryptocashbackaddress": "Adres publiczny",
    "detaillabelcryptocashbackaddresscomp": "Skompresowany adres publiczny",
    ...
    "footersupport": "Wspomóż CryptoCashBack-paperwallet",
    ...
    "defaultTitle": "CryptoCashBack-paperwallet – uniwersalny generator portfeli papierowych dla CryptoCashBacka i innych kryptowalut",
    ...
    "paperwalletback": "<ul><li> Aby wpłacić dodatkowe fundusze do tego portfela, wyślij cryptocashbacky na publiczny adres.</li><li> Sprawdź dostępne środki szukając publicznego adresu w usługach takich jak blockchain.info.</li><li><b>NIE ODSŁANIAJ KLUCZA PRYWATNEGO</b> dopóki nie jesteś gotowy na wydanie wszystkich środków, znajdujących się w tym portfelu.</li></ul><b>Wpłacona kwota :</b> ___________       <b>Data :</b> ________________<br /><b>Uwagi :</b> ______________________________________",
},
