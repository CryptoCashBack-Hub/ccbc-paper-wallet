"zh": {
  "choosecurrency": "選擇幣別",
    ...
    "detailwallet": "錢包細節",
    "donate": "捐款支持",
    "generatelabelcryptocashbackaddress": "新錢包地址產生中......",
    "generatelabelmovemouse": "請四處移動滑鼠產生亂數",
    "generatelabelkeypress": "或在後方空格填寫隨機字符",
    "skipMessage": "若您不想產生隨機亂碼，您可以跳過此步驟。",
    "singlelabelcryptocashbackaddress": "公鑰",
    "singleshare": "地址",
    "singlelabelprivatekey": "私鑰(可導入電子錢包客戶端)",
    "singlesecret": "私鑰",
    "securitystep0title": "首先：安全檢查清單建議的步驟",
    "securitystep0": "請先自<a href=\"https://github.com/CryptoCashBack-Hub/ccbc-paper-wallet\">Github</a>處<strong>下載</strong>這個網站，接著直接在您的電腦開啟index.html檔案。為了提高安全性，在生成錢包地址時，請<strong>斷開網路連結</strong>(例如拔除網路線或關閉wifi)。駭客很輕易能在6000多行javascript中找到你的私鑰，透過原始碼版本控制。可以交叉確認是否運行順利。",
    ...
    "brainlabelcryptocashbackaddress": "公鑰：",
    ...
    "detaillabelcryptocashbackaddress": "公鑰地址",
    "detaillabelcryptocashbackaddresscomp": "經壓縮的公鑰地址",
    ...
    "footersupport": "贊助CryptoCashBack-paperwallet",
    "footerlabelgithub": "下載(GitHub Repository)",
    "footerlabelcopyright2": "源代碼中包含JavaScript版權。",
    "defaultTitle": "CryptoCashBack-paperwallet - 全球通用的比特幣及其他加密貨幣紙錢包產生器",
    "title": "紙錢包產生器",
